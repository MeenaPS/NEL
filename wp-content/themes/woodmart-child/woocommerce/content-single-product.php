...
<?php if ( ( $product_design == 'alt' && ( $breadcrumbs_position == 'default' || empty( $breadcrumbs_position ) ) ) || $breadcrumbs_position == 'below_header' ): ?>
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( $single_product_class ); ?>>

	<div class="<?php echo esc_attr( $container_summary ); ?>">

		<div class="row product-image-summary-wrap">
			<!-- we have changed the breadcrumbs display position-start -->
			<div class="single-breadcrumbs-wrapper">
			...
			<?php 
				if($_GET['quote']){
					echo '<div id ="message_hide" class="message_hide">Thank you! Your quote was sent successfully.</div>';
				}?>
			<div class="product-image-summary <?php echo esc_attr( $product_image_summary_class ); ?>">
				<div class="row product-image-summary-inner">
					<div class="<?php echo esc_attr( $product_images_class ); ?> product-images" <?php echo ( $product_images_attr ); ?>>
					...
					<div class="<?php echo esc_attr( $product_summary_class ); ?> summary entry-summary">
						<div class="summary-inner">
							<?php if ( ( $product_design == 'default' && ( $breadcrumbs_position == 'default' || empty( $breadcrumbs_position ) ) ) || $breadcrumbs_position == 'summary' ): ?>
								<!-- <div class="single-breadcrumbs-wrapper">
									<div class="single-breadcrumbs">
										<?php woodmart_current_breadcrumbs( 'shop' ); ?>
										<?php if ( woodmart_get_opt( 'products_nav' ) ): ?>
							...
							<?php
								...
								/* Request quote form-start*/
  								$id = $product->get_id(); // get product id
  								$product_stock = get_post_meta( $id, '_stock_status', true );
  								$quote_url = get_home_url().'/request-quote/?pid='.$id; //request form url
  								$login_url = get_home_url().'/login/';
  								if($product_stock == 'instock'){
  								if ( is_user_logged_in() ){
							?>
							<div class="req-quote"><a href="<?php echo $quote_url ?>">Request Quote</a></div>
							<?php } else {?>
							<div class="req-quote"><a href="<?php echo $login_url ?>">Request Quote</a></div>
							<?php } } ?>
